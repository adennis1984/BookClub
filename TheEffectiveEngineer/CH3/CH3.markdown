# CH3. Prioritize Regularly - 定期審視優先層級

## 摘要

### Track To-Dos in a Single, Easily Accessible List - 在一個簡單易用的列表中跟踪所有待辦事項 
...
### Focus on What Directly Produces Value - 專注於什麼才會直接產生價值
...
### Focus on the important and non-urgent - 專注於重要且不緊急的事項
...
### Protect Your Maker’s Schedule - 保護您的製作者的日程表
...
### Limit the Amount of Work in Progress - 限制半成品的數量
...
### Fight Procrastination with If-Then Plans - 讓 if-then 計劃來打擊拖延症

* 綁定意圖去做某件事以顯著地提高你完成它的可能性。
* 缺乏動力可以利用 if-then 計畫提供潛意識一些點可以跟進
...
### Make prioritization a habit - 讓排定優先層級成為一種習慣
